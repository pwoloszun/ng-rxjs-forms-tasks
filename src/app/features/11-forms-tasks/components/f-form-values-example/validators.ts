...
export const nameCountryValidator = (group: FormGroup): ValidationErrors | null => {
...
export const properNameValidator = (personalInfoGroup: FormGroup): ValidationErrors | null => {
  const fullNameCtrl = personalInfoGroup.get('fullName') as FormControl;
  const name = fullNameCtrl.value as string;
